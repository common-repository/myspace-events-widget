...
= What is cache time Option? =

You can specify your cache alive time, by setting your time (in seconds) in the Cache time field.
The last event loaded may freeze (for cache time seconds) in a local file to give faster loading times!
